...
// import { Upload, FileText, Send, Activity, X } from 'lucide-react';
...
//           <h1 className="text-lg tracking-widest font-light">
//             KNOWLEDGE AI
//           </h1>

//           <Link href="/status">
//             <Activity className="w-5 h-5 text-white/60 hover:text-white transition" />
//           </Link>
//         </div>
//       </header>
...
//         {/* Sidebar */}
//         <aside className="col-span-3 border border-white/10 rounded-2xl p-6 bg-white/[0.03]">
...
//             className="border border-white/20 rounded-xl p-6 text-center cursor-pointer hover:border-white transition"
//           >
//             <Upload className="w-6 h-6 mx-auto mb-2 text-white/70" />
//             <p className="text-sm text-white/80">Upload File</p>
//           </div>
...
//               <div
//                 key={doc.id}
//                 className="flex justify-between items-center border border-white/10 rounded-lg px-3 py-2 hover:border-white/30 transition"
//               >
...
//                   <X className="w-4 h-4 text-white/40 hover:text-red-400 transition" />
//                 </button>
//               </div>
//             ))}
//           </div>
...
//         {/* Chat Section */}
//         <section className="col-span-6 flex flex-col border border-white/10 rounded-2xl p-8 bg-white/[0.02] min-h-[600px]">
...
//                   Upload a document and begin your query.
//                 </p>
//               </div>
//             )}
...
//                   <div className="bg-white text-black px-5 py-3 rounded-2xl text-sm max-w-[75%]">
//                     {item.question}
//                   </div>
//                 </div>
...
//                   <div className="border border-white/20 rounded-2xl px-5 py-4 text-sm max-w-[85%] text-white/90 bg-white/[0.05]">
//                     {item.answer}
//                   </div>
//                 </div>
...
//           {/* Input */}
//           <div className="mt-8 flex items-center gap-3 border border-white/20 rounded-xl px-4 py-3 bg-white/5">
...
//   className="flex-1 bg-transparent resize-none focus:outline-none text-white placeholder:text-white/40 text-sm caret-white"
//   rows={1}
// />
...
//               onClick={handleAsk}
//               disabled={loading}
//               className="px-5 py-2 bg-white text-black rounded-lg text-sm font-medium hover:bg-white/90 transition"
//             >
//               Send
//             </button>
...
//               <div>
//                 <p className="text-white/40 text-xs mb-1">Document</p>
//                 <p>{history[0].source}</p>
//               </div>

//               <div>
//                 <p className="text-white/40 text-xs mb-1">Snippet</p>
